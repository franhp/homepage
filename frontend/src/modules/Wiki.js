  ...
  return (
    <Card>
      ...
      <Accordion.Collapse eventKey={document.fields.slug}>
        <Card.Body>
          <ReactMarkDown
            source={document.fields.content}
            renderers={{ code: CodeBlock }}
          />
          <div className="text-right">
            Last Update: <i>{document.fields.date.split("T")[0]}</i>
          </div>
        </Card.Body>
      </Accordion.Collapse>
    </Card>
            ...
            return (
              <ListGroup.Item action href={"#" + category.fields.slug}>
                ...
                <div className="badge badge-secondary badge-pill">
                  {documents
                    .map((document) => {
                      return document.fields.category === category.pk ? 1 : 0;
                    })
                    .reduce((a, b) => a + b, 0)}
                </div>
              </ListGroup.Item>
